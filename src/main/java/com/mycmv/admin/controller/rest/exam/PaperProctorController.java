...
public class PaperProctorController {
    ...
    @ResponseBody
    @GetMapping("pageList")
    public ResponseObject list(AbstractUser user, PaperProctor item, int pageIndex, int pageSize) {
    ...
    @ResponseBody
    @PostMapping("create")
    public ResponseObject create(AbstractUser user, @RequestBody PaperProctor item) {
    ...
    @ResponseBody
    @PostMapping("edit")
    public ResponseObject edit(AbstractUser user, @RequestBody PaperProctor item) {
