...
public class PaperResultInfoController {
    ...
    @ResponseBody
    @GetMapping("pageList")
    public ResponseObject list(@CurrentUser AbstractUser user, PaperResultInfo item, int pageIndex, int pageSize) {
        logger.info("用户 {} ，访问 {} , 参数：{}", user.getUserName(), "exam/paperResultInfo/create", JSON.toJSON(item));
    ...
    @ResponseBody
    @PostMapping("create")
    public ResponseObject create(@CurrentUser AbstractUser user, @RequestBody PaperResultInfo item) {
        logger.info("用户 {} ，访问 {} , 参数：{}", user.getUserName(), "exam/paperResultInfo/create", JSON.toJSON(item));
        ResponseObject resObj = new ResponseObject();
    ...
    public ResponseObject findById(@CurrentUser AbstractUser user, Integer id) {
        logger.info("用户 {} ，访问 {} , 参数：{}", user.getUserName(), "exam/paperResultInfo/findById", id);
        ResponseObject resObj = new ResponseObject();
    ...
    @ResponseBody
    @PostMapping("edit")
    public ResponseObject edit(@CurrentUser AbstractUser user, @RequestBody PaperResultInfo item) {
        logger.info("用户 {} ，访问 {} , 参数：{}", user.getUserName(), "exam/paperResultInfo/edit", JSON.toJSON(item));
    ...
    public ResponseObject delete(@CurrentUser AbstractUser user, @RequestBody LongIdListVo longIdListVo) {
        logger.info("用户 {} ，访问 {} , 参数：{}", user.getUserName(), "exam/paperResultInfo/remove", JSON.toJSON(longIdListVo));
        ResponseObject resObj = new ResponseObject();
