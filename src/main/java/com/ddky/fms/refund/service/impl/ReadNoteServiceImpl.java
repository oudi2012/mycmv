...
import com.ddky.fms.refund.mapper.userlogs.ReadNoteMapper;
import com.ddky.fms.refund.model.userlogs.entry.ReadNote;
import com.ddky.fms.refund.service.ReadNoteService;
...
public class ReadNoteServiceImpl implements ReadNoteService {
    ...
    @Autowired
    private ReadNoteMapper termMapper;

    @Override
    public PageInfo<ReadNote> list(ReadNote termInfo, int pageIndex, int pageSize) {
        ...
        List<ReadNote> termTeachersList = termMapper.list(termInfo);
